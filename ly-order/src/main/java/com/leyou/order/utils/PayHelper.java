...
/*
            ...
            if (WXPayConstants.FAIL.equals(result.get("return_code"))) {
                ...
                throw new LyException(ExceptionEnum.CONNECT_WXPAY_FAIL);
            }
     ...
     * @param data
     */
    private void isSignatureValid(Map<String, String> data) {
    ...
    public void handleNotify(Map<String, String> msg) {
        ...
        int count = statusMapper.updateByPrimaryKeySelective(orderStatus1);
        if (count != 1){
            throw new LyException(ExceptionEnum.UPDATE_ORDER_STATUE_FAIL);
        }
